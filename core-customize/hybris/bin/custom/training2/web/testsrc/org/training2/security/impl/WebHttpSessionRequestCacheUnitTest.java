...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/training2/electronics/en",
						"https://electronics.local:9002/training2/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/training2/electronics/en",
						"https://electronics.local:9002/training2/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/training2/electronics/ja/Y/Z",
						"https://electronics.local:9002/training2/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/training2/electronics/en",
						"https://electronics.local:9002/training2/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/training2",
						"https://electronics.local:9002/training2"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/training2",
						"https://electronics.local:9002/training2/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/training2/electronics/en",
						"https://electronics.local:9002/training2/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
